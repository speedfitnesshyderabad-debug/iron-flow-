...
const CheckinsLog: React.FC = () => {
    const { attendance, users, branches, currentUser, activeBranchId } = useAppContext();
    ...
    }, [attendance, dateFilter, searchQuery, roleFilter, activeBranchId, currentUser, users]);
    ...
    return (
        <div className="p-6 md:p-8 animate-[fadeIn_0.5s_ease-out] max-w-7xl mx-auto space-y-8">
            ...
            {/* Filters */}
            <div className="bg-white p-6 rounded-[2.5rem] shadow-xl border-4 border-slate-50 flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-4">
                    <input
                        ...
                        className="bg-slate-50 px-6 py-4 rounded-2xl font-bold text-slate-700 border-2 border-slate-100 focus:border-blue-500 outline-none"
                    />

                    <select
                        value={roleFilter}
                        onChange={(e) => setRoleFilter(e.target.value as 'ALL' | 'MEMBER' | 'STAFF')}
                        className="bg-slate-50 px-6 py-4 rounded-2xl font-bold uppercase text-xs tracking-widest border-2 border-slate-100 focus:border-blue-500 outline-none"
                    >
            ...
            {/* Table */}
            <div className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border-4 border-slate-50">

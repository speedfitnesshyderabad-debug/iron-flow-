...
const MemberPortal: React.FC = () => {
   ...
   const handleOpenRenew = (sub: any) => {
      ...
      setRenewTarget({ member: currentUser, currentPlan: plan });
                           ...
                           return (
                              <div key={sub.id} className="p-4 bg-slate-50 rounded-2xl border border-slate-100">
                                 ...
                                 <button
                                    ...
                                    className="mt-2 w-full py-2 bg-blue-100 text-blue-700 rounded-lg text-[10px] font-black uppercase tracking-widest hover:bg-blue-200 transition-colors"
                                 >
                                    Renew Now
                                 </button>
                              </div>
